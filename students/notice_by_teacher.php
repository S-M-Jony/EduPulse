			...
			<div class="container">
				...
				<div class="col-md-6">
					<div class="post_wrapper">
                        <?php
                            if(isset($_GET['notice_author'])){
                                $notice_author = $_GET['notice_author'];
                                ...
                                $query .= " FROM notification LEFT JOIN courses ON notification.notification_course_id = courses.c_id LEFT JOIN teacher ON courses.course_teacher_id = teacher.teacher_id WHERE notification_teacher_id = '{$notice_author}' AND notification.semester = '{$semester}' ORDER BY notification_id DESC";
