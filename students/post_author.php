...
//                                $query = "SELECT * FROM posts WHERE post_author = '{$post_author}'  ORDER BY post_id DESC";
                                ...
                                $query .= " FROM posts LEFT JOIN courses ON posts.post_course_id = courses.c_id WHERE post_author = '{$post_author}' AND courses.semester = '{$semester}' ORDER BY post_id DESC";
