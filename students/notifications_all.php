...
<?php
//    $q = "SELECT * FROM courses WHERE notification_course_id = {$student_id}";
				...
				<div class="col-md-6">
					<div class="post_wrapper">
                        <?php
                                ...
                                $query .= " FROM notification LEFT JOIN courses ON notification.notification_course_id = courses.c_id LEFT JOIN teacher ON courses.course_teacher_id = teacher.teacher_id WHERE notification.semester = '{$semester}' ORDER BY notification_id DESC";
